...
CREATE TABLE Equipo 
    ( 
     ...
     director_tecnico_eq VARCHAR2 (150)  NOT NULL , 
...
CREATE TABLE Llave_Mundial 
    ...
    LOGGING 
;
CREATE UNIQUE INDEX Llave_Mundial__IDX ON Llave_Mundial 
    ( 
     Fase_id_fa ASC 
    ) 
    LOGGING 
...
ALTER TABLE Pais_Clasificado 
    ADD CONSTRAINT Pais_Clasificado_PK PRIMARY KEY ( Pais_id_pa, Grupo_id_gr ) ;
...
CREATE TABLE Plantilla 
    ( 
     ...
     Equipo_id_eq NUMBER  NOT NULL , 
     Equipo_id_pa NUMBER  NOT NULL 
    ) 
    LOGGING 
;
...
ALTER TABLE Grupo 
    ADD CONSTRAINT Grupo_Mundial_FK FOREIGN KEY 
    ( 
     Mundial_id_mu
    ) 
    REFERENCES Mundial 
...
ALTER TABLE Pais_Clasificado 
    ADD CONSTRAINT Pais_Clasificado_Grupo_FK FOREIGN KEY 
    ( 
     Grupo_id_gr
    ) 
    REFERENCES Grupo 
...
ALTER TABLE Pais_Clasificado 
    ADD CONSTRAINT Pais_Clasificado_Pais_FK FOREIGN KEY 
    ( 
     Pais_id_pa
    ) 
    REFERENCES Pais 
...
ALTER TABLE Plantilla 
    ADD CONSTRAINT Plantilla_Equipo_FK FOREIGN KEY 
    ( 
     Equipo_id_eq,
     Equipo_id_pa
    ) 
